...
public interface GuitarAmpCabinetDao extends JpaRepository<GuitarAmpCabinet, Integer> {
	...
	public static final String CUSTOM_SEARCH_QUERY = "select c from GuitarAmpCabinet c where" +
	...
	public static final String DISTINCT_BRAND_QUERY = "select distinct new Brand(br.id, br.brand)" +
			"from GuitarAmpCabinet bc left join Brand br on br.id = bc.brand";
	...
	public Page<GuitarAmpCabinet> findByCustomSearch(@Param("mayor") Optional<Double> mayor,
	...
	public GuitarAmpCabinet findByItemID(@Param("item") String itemID);
